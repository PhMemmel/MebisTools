...
public class StudentTimetableDistribution {

    File dir = null;
    File gradingTable = null;
    File studentIdTable = null;
    ...
    public void start() {
        ...
        /*
         * configure FileChooser dialog to choose txt file containing the student ID generated by Untis/ASV
         * you get this by exporting it via "Info-Stundenplan"->"Datenbank"->"Export". The file is called "student.txt"
         */
        fileChooser.setCurrentDirectory(dir);
        fileChooser.setDialogTitle("W\u00e4hlen Sie die aus Untis exportierte txt-Datei, die den Sch\u00fclernamen " +
                "und die eindeutige Sch\u00fcler-ID enth\u00e4lt.");
        ...
        if (fileChooser.showOpenDialog(null) == JFileChooser.CANCEL_OPTION) {
            ...
            studentIdTable = fileChooser.getSelectedFile();
            if (studentIdTable != null) {
                if (!studentIdTable.canRead()) {
                    showMessageDialog(null, "Untis-Export-Datei mit Sch\u00fclern " +
        ...
        excludedFiles.add(studentIdTable);
        excludedFiles.add(outputDir);

        /*
         * try for each file in the given directory which is supposed to be distributed:
         * - extract student ID out of given filename
         * - extract fullname out of untis database export file via student ID
         * - extract grading table student ID for renaming file
        ...
        for (File file : dir.listFiles()) {
            if (!excludedFiles.contains(file) && file.isFile()) {
                ...
                String untisStudentId = fileNameWithoutSuffix[fileNameWithoutSuffix.length - 1];
                File userDir = null;

                System.out.println("Student " + untisStudentId + " wird bearbeitet.");

                String fullName = getFullNameOutOfUntisExportFile(untisStudentId);

                String newFileName = studentFileName + "." + fileNameParts[1];
     ...
     */
    private String getFullNameOutOfUntisExportFile(String studentId) {
        String fullName = "";
        ...
        try {
            ...
            reader = new BufferedReader(new InputStreamReader(new FileInputStream(studentIdTable),
            ...
            while (line != null && !line.isEmpty()) {
                ...
                if (splitLine[0].equals(studentId)) {
                    ...
                    String[] lastNameParts = splitLine[1].split(" ");
                    String lastName = "";
                    ...
                    String firstName = splitLine[2].split(" ")[0];
